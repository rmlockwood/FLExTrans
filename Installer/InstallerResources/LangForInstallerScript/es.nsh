...
!define ES_YES                "Sí"
!define ES_NO                 "No"
!define ES_PYTHON_OLD         "está instalado, pero FLExTrans requiere Python ${PYTHON_VERSION}. Al instalar, use la opción 'Install now'.$\n¿Instalar Python ${PYTHON_VERSION} ahora?"
!define ES_INSTALL_PYTHON     "FLExTrans requiere Python ${PYTHON_VERSION} para ejecutarse. Se recomienda instalarlo ahora. Al instalar, use la opción 'Install now'.$\n¿Instalar Python ${PYTHON_VERSION}?"
