...
!define DE_YES                "Ja"
!define DE_NO                 "Nein"
!define DE_PYTHON_OLD         "ist installiert, aber FLExTrans benötigt Python ${PYTHON_VERSION}. Verwenden Sie bei der Installation die Option 'Install now'.$\nPython ${PYTHON_VERSION} jetzt installieren?"
!define DE_INSTALL_PYTHON     "FLExTrans benötigt Python ${PYTHON_VERSION} zum Ausführen. Es wird empfohlen, es jetzt zu installieren. Verwenden Sie bei der Installation die Option 'Install now'.$\nPython ${PYTHON_VERSION} installieren?"
