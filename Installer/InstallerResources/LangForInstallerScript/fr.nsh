...
!define FR_YES                "Oui"
!define FR_NO                 "Non"
!define FR_PYTHON_OLD         "est installé, mais FLExTrans nécessite Python ${PYTHON_VERSION}. Lors de l'installation, utilisez l'option 'Install now.'$\nInstaller Python ${PYTHON_VERSION} maintenant?"
!define FR_INSTALL_PYTHON     "FLExTrans nécessite Python ${PYTHON_VERSION} pour fonctionner. Il est recommandé de l'installer maintenant. Lors de l'installation, utilisez l'option 'Install now'.$\nInstaller Python ${PYTHON_VERSION}?"
