...
!define EN_YES                "Yes"
!define EN_NO                 "No"
!define EN_PYTHON_OLD         "is installed, but FLExTrans requires Python ${PYTHON_VERSION}. When installing, use the 'Install now' option.$\nInstall Python ${PYTHON_VERSION} now?"
!define EN_INSTALL_PYTHON     "FLExTrans requires Python ${PYTHON_VERSION} to run. It is recommended that you install it now. When installing, use the 'Install now' option.$\nInstall Python ${PYTHON_VERSION}?"
