...
rem core models
copy CatalogTargetAffixes.py Install2.1.1\FLExTrans\FlexTools\Modules
copy ConvertTextToSTAMPformat.py Install2.1.1\FLExTrans\FlexTools\Modules
copy ExtractBilingualLexicon.py Install2.1.1\FLExTrans\FlexTools\Modules
copy ExtractSourceText.py Install2.1.1\FLExTrans\FlexTools\Modules
copy SynthesizeText.py Install2.1.1\FLExTrans\FlexTools\Modules
copy InsertTargetText.py Install2.1.1\FLExTrans\FlexTools\Modules
copy RunApertium.py Install2.1.1\FLExTrans\FlexTools\Modules
copy RunTreeTran.py Install2.1.1\FLExTrans\FlexTools\Modules
...
copy LinkSenseTool.py Install2.1.1\FLExTrans\FlexTools\Modules
...
copy LiveRuleTesterTool.py Install2.1.1\FLExTrans\FlexTools\Modules
...
copy ViewSrcTgt.py Install2.1.1\FLExTrans\FlexTools\Modules
copy SrcTgtViewer.py Install2.1.1\FLExTrans\FLExTools\Modules\FLExTrans\Lib

rem SetUp Gramm Categories pieces
copy SetUpTransferRuleGramCat.py Install2.1.1\FLExTrans\FlexTools\Modules

rem Testbed pieces
copy TestbedValidator.py Install2.1.1\FLExTrans\FLExTools\Modules\FLExTrans\Lib
copy StartTestbed.py Install2.1.1\FLExTrans\FlexTools\Modules
copy EndTestbed.py Install2.1.1\FLExTrans\FlexTools\Modules
copy OverWriteTestDlg.py Install2.1.1\FLExTrans\FLExTools\Modules\FLExTrans\Lib
copy TestbedLogViewer.py Install2.1.1\FLExTrans\FlexTools\Modules
...
copy ImportFromParatext.py Install2.1.1\FLExTrans\FlexTools\Modules
copy ExportToParatext.py Install2.1.1\FLExTrans\FlexTools\Modules
...
copy SettingsGUI.py Install2.1.1\FLExTrans\FlexTools\Modules
...
rem Other Tools
copy CleanFiles.py Install2.1.1\FLExTrans\FlexTools\Modules
