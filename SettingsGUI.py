...
widgetList = [
   ...
   ["Use composed characters in editing?", "composed_yes", "composed_no", YES_NO, object, object, object, loadYesNo, ReadConfig.COMPOSED_CHARACTERS, \
    "When editing transfer rules, the replacement file, the testbed and other places, if Yes, \nunicode characters will be composed (NFC). If No, characters will be decomposed."],\
