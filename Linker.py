...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.HideProperNounsCheckBox.setGeometry(QtCore.QRect(340, 410, 121, 27))
        ...
        self.ZoomLabel.setGeometry(QtCore.QRect(470, 414, 41, 20))
        self.ZoomLabel.setObjectName("ZoomLabel")
        self.FontNameLabel = QtWidgets.QLabel(self.centralwidget)
        self.FontNameLabel.setGeometry(QtCore.QRect(674, 414, 110, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.RebuildBilingCheckBox.setText(_translate("MainWindow", "Rebuild Binlingual Lexicon"))
