...
!define TOFT "TOFT"
!define PRODUCT_VERSION "3.14.1${TOFT}"
...
; Always 4 numerals
VIProductVersion 3.14.1.${BUILD_NUM}
...
LangString Run_Testbed    ${LANG_GERMAN} "Tests durchf�hren"
...
# Spanish
LangString Drafting       ${LANG_SPANISH} "Redacci�n"
LangString Run_Testbed    ${LANG_SPANISH} "Ejecutar testbed"
LangString Tools          ${LANG_SPANISH} "Herramientas"
LangString Synthesis_Test ${LANG_SPANISH} "Prueba de s�ntesis"
...
LangString ProdModeLabelText1 ${LANG_SPANISH} "�Uso en producci�n?"
...
LangString ProdModeLabelText2 ${LANG_GERMAN}  "Um eine einfachere FLExTrans-Oberfl�che f�r den Produktivbetrieb zu installieren, w�hlen Sie �Ja�. F�r die FLExTrans-Entwicklung w�hlen Sie �Nein�."
LangString ProdModeLabelText2 ${LANG_SPANISH} "Para instalar una interfaz FLExTrans m�s sencilla para uso en producci�n, elija S�. Para trabajo de desarrollo de FLExTrans, elija No"
