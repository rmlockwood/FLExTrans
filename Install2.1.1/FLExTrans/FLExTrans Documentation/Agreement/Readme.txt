...
3. Copy FlexTrans.config from the FLExTrans Documentation\Agreement folder to the WorkProjects\Swedish-German-Agreement\Config folder
5. Copy transfer_rules.t1x from the FLExTrans Documentation\Agreement folder to the WorkProjects\Swedish-German-Agreement folder
