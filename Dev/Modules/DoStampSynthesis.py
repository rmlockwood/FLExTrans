...
#   12/5/14
#
#   Version 3.13.4 - 9/3/25 - Ron Lockwood
    ...
    for i, entry in enumerate(TargetDB.LexiconAllEntries()):
        ...
        if custXampleEntryFieldID:
            ...
            if not isinstance(xAmplePropList, list):
                ...
                err_list.append(("Aborting target lexicon export because the custom XAMPLE field is not a list. When you define the custom XAMPLE field, it must be a list.", 2))
                return err_list
