...
#   12/5/14
#
#   Version 3.13.4 - 5/9/25 - Ron Lockwood
...
if translatorForGlobals.load(f"DoStampSynthesis_{Utils.getInterfaceLangCode()}.qm", FTPaths.TRANSL_DIR):
...
def MainFunction(DB, report, modifyAllowed):
    ...
    for lib in librariesToTranslate + ['DoStampSynthesis']:
