...
<context>
    ...
    <message>
        <location filename="../FixUpSynthText.py" line="76"/>
        <source>Fix Up Synthesis Text</source>
        <translation>Synthese-Text korrigieren</translation>
    </message>
    <message>
        <location filename="../FixUpSynthText.py" line="79"/>
    ...
    <message>
        <location filename="../FixUpSynthText.py" line="72"/>
...
Fix Up Synthesis Text Rules File as specified in the Settings.</source>
        <translation type="obsolete">Dieses Modul führt eine Reihe von Such- und Ersetzungsoperationen durch, um den Text zu korrigieren, der aus der Synthese stammt. Die Operationen werden mit dem Modul &quot;Text Out Rules&quot; definiert. Die Regeln werden in der Datei &quot;Fix Up Synthesis Text Rules&quot; gespeichert, wie in den Einstellungen angegeben.</translation>
    </message>
    <message>
        <location filename="../FixUpSynthText.py" line="119"/>
        <source>The rules file: {textOutRulesFile} could not be found. Use the Text Out Rules module to define the rules.</source>
        <translation>Die Regeldatei: {textOutRulesFile} konnte nicht gefunden werden. Verwenden Sie das Modul &quot;Text Out Rules&quot;, um die Regeln zu definieren.</translation>
    </message>
    <message>
        <location filename="../FixUpSynthText.py" line="132"/>
    ...
    <message>
        <location filename="../FixUpSynthText.py" line="81"/>
        <source>This module will run a set of search and replace operations to fix up the text that comes out of 
synthesis. The operations are defined with the {textOutRulesModule} module. The rules are stored in the
Fix Up Synthesis Text Rules File as specified in the Settings.</source>
        <translation>Dieses Modul führt eine Reihe von Such- und Ersetzungsoperationen durch, um den Text zu korrigieren, der aus der Synthese stammt. Die Operationen werden mit dem {textOutRulesModule}-Modul definiert. Die Regeln werden in der Datei &quot;Fix Up Synthesis Text Rules&quot; gespeichert, wie in den Einstellungen angegeben.</translation>
    </message>
</context>
</TS>
