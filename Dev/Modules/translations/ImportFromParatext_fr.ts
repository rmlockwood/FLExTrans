...
cluster projects in the main FLExTrans Settings, then come back to this module.</source>
        <translation>Ce module vous demande quel projet Paratext, quel livre et quels chapitres doivent être
importés. Le nom du livre doit être donné sous forme d'abréviation de trois lettres comme dans
Paratext. Ces chapitres sont rassemblés et insérés dans le projet FLEx actuel en tant que
nouveau texte. Si vous voulez inclure diverses choses, cochez la case appropriée.
