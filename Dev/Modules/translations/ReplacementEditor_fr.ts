...
vocative singular, you can specify that here.</source>
        <translation>Ce module fournit une interface pour modifier le dictionnaire de remplacement
qui vous permet de remplacer les liens créés par le {linkSenseToolModule}
en présence d'affixes particuliers. Par exemple, si vous avez un nom qui
est généralement traduit d'une certaine façon, mais a une traduction différente au
