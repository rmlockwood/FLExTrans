...
This is typically called source_text-aper.txt and is usually in the Build folder.</source>
      <translation>Este módulo usará el Nombre del texto fuente configurado en los Ajustes. Primero verificará si cada palabra en el texto seleccionado está completamente analizada (el glosario de palabras o la categoría no son necesarios). Si el texto no está completamente analizado, recibirás advertencias. Luego, este módulo recorrerá cada paquete en el texto interlineal y exportará información en el formato que necesita Apertium. La idea general es que los afijos y clíticos se exportarán como &lt;gloss&gt; y las raíces/temasrasgos de flexión se exportarán como head_word&lt;pos&gt;&lt;feat1&gt;...&lt;featN&gt;&lt;class1&gt;...&lt;classN&gt;. Donde feat1 a featN son uno o más rasgos de flexión que pueden estar presentes para la raíz/tema y class1 a classN son clases de flexión que pueden estar presentes en el tema. Las oraciones exportadas se almacenarán en el archivo especificado por la configuración del archivo de salida del texto analizado. Este archivo generalmente se llama source_text-aper.txt y suele estar en la carpeta "Build".</translation>
    </message>
    <message>
