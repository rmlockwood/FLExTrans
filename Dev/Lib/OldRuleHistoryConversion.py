...
#
#   Version 3.17 saved its copies of the transfer rules file in Output\\rule-history, with a 'created' subfolder for the Live Rule Tester's copies and a 'run' subfolder for Start Testbed's, instead
...
# The folder version 3.17 and earlier used, where its contents go, and the note left with them.
