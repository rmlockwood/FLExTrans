...
#
#   Earlier FLExTrans releases used a different layout - Output\rule-history, with a subfolder per producer instead of a tag in each file name. Bringing one of those folders forward is the whole job of
